...
- 🔊 Another new project I'm working on is [Variefy](https://variefy.herokuapp.com), a Spotify playlist generator that recommends new, unfamiliar music that is similar to your current music taste using K-Means machine learning algorithm and the Spotify API. Repo pinned to profile.
